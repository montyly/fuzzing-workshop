...
We will test the following contract _[token.sol](./exercises/exercise1/token.sol)_:
...
The skeleton for this exercise is (_[template.sol](./exercises/exercise1/template.sol)_):
