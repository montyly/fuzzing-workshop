...
We will test the following contract, _[token.sol](./exercises/exercise2/token.sol)_:
...
The skeleton for this exercise is (_[template.sol](./exercises/exercise2/template.sol)_):
